...
import util.PersistInitialData;
import view.SystemJFrame;
import model.Client;
import model.Role;
...
//	}	
//	
		ClientDM testOne = new ClientDM("src/data/client_dataToload.csv");
		PersistInitialData peresisit = new PersistInitialData();
		peresisit.initClientData();
